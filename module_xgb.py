...
if __name__ == '__main__':
    ...
    confusion_matrix_result = confusion_matrix(devel_preds, devel_y)
    print('The confusion matrix result:\n', confusion_matrix_result)
    cm_analysis(devel_y, devel_preds, f'dist/cm/cm_xgb2', sorted(set(devel_y)))
    uar_test = recall_score(devel_y, devel_preds, average="macro")
